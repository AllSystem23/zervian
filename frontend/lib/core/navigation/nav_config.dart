  ...
  static final List<NavModule> allModules = [
    ...
    const NavModule(
      ...
      children: [
        ...
        NavItem(id: 'flota-palmtrack-production', label: 'PalmTrack Producción', icon: Icons.agriculture_outlined, route: '/palmtrack/production', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-farms', label: 'PalmTrack Fincas', icon: Icons.landscape_outlined, route: '/palmtrack/farms', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-lots', label: 'PalmTrack Lotes', icon: Icons.grid_view_outlined, route: '/palmtrack/lots', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-producers', label: 'PalmTrack Productores', icon: Icons.people_outline, route: '/palmtrack/producers', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-sales', label: 'PalmTrack Ventas', icon: Icons.receipt_long_outlined, route: '/palmtrack/sales', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-inventory', label: 'PalmTrack Inventario', icon: Icons.inventory_2_outlined, route: '/palmtrack/inventory', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-sync', label: 'PalmTrack Sync', icon: Icons.sync_outlined, route: '/palmtrack/sync', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-conflicts', label: 'PalmTrack Conflictos', icon: Icons.sync_problem_outlined, route: '/palmtrack/conflicts', roles: ['SuperAdmin', 'CompanyAdmin']),
        NavItem(id: 'flota-palmtrack-settings', label: 'PalmTrack Config', icon: Icons.settings_outlined, route: '/palmtrack/settings', roles: ['SuperAdmin']),
